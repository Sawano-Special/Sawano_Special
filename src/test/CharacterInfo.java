...
public class CharacterInfo {
    ...
    static {
        ...
        characters.put("3", new Character("剣士", "エルドリス帝国に所属する剣士は、職人気質で日々の厳しい訓練を怠らない。その結果、彼の足さばきは一級品となり、戦場ではその驚異的なスピードで敵を翻弄する。剣の腕も確かで、迅速な動きと正確な一撃で数多くの敵を討ち取ってきた。彼の努力は決して表には出ないが、その実力はエルドリス帝国の中でも随一。常に自己を磨き続ける剣士の姿勢は、同胞からも敵からも尊敬されている。", "/hero_inf/hero2.png"));
    }
