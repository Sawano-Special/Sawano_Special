...
public class CharacterInfo {
    ...
    static {
        ...
        characters.put("2", new Character("魔法使い", "エルドリス帝国は存続の危機に直面している。その希望の光として、一級魔法使いの弟子である若き魔法使いがいる。将来有望とされる彼女は、まだ潜在能力の全てを発揮できていないが、その圧倒的な攻撃力で敵を圧倒する。HPとスピードは低めだが、その一撃の威力は計り知れない。国の未来を背負う彼女の成長に、周囲は大きな期待を寄せている。エルドリス帝国の運命は、彼女の手に託されているのだ。", "/hero_inf/hero1.jpg"));
