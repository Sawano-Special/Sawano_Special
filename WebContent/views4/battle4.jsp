...
<meta charset="UTF-8">
<title>対戦画面</title>
<link rel="stylesheet" href="<c:url value='/views4/battle4style.css' />">
...
<body>
    <div class="layer">
        ...
        <div class="player">
            <img src="${pageContext.request.contextPath}/views4/<%= imagePath %>"
        ...
        <form method="POST" action="/Sawano_special/practice4">
            <div class="attack">
      <% if (Boolean.TRUE.equals(request.getAttribute("attack_locked"))) { %>
        ...
        <form action="${pageContext.request.contextPath}/StageSelect"
            method="get">
            <button type="submit" id="stage-select-button">ステージ4クリア！！</button>
        </form>
    </div>
</body>
</html>
