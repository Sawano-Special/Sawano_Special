...
<meta charset="UTF-8">
<title>対戦画面</title>
<link rel="stylesheet" href="<c:url value='/views2/battle2style.css' />">
...
<body>
    <div class="layer">
        ...
        <div class="player">
            <img src="${pageContext.request.contextPath}/views2/<%= imagePath %>"
      ...
      <% if (Boolean.TRUE.equals(request.getAttribute("attack_locked"))) { %>
        ...
        <form action="${pageContext.request.contextPath}/StageSelect"
            method="get">
            <button type="submit" id="stage-select-button">ステージ2クリア！！</button>
        </form>
    </div>
</body>
</html>
