...
<body>
    <div class="layer">
        ...
        <div class="enemy">
            <img src="<c:url value='/views5/maou.png' />" alt="相手のポケモン"
                class="enemy-img">
            <div class="hp-bar">
        ...
        <div class="player">
            <img src="${pageContext.request.contextPath}/views5/<%= imagePath %>"
      ...
      <% if (Boolean.TRUE.equals(request.getAttribute("attack_locked"))) { %>
        ...
        <form action="${pageContext.request.contextPath}/StageSelect"
            method="get">
            <button type="submit" id="stage-select-button">ステージ5クリア！！</button>
        </form>
    </div>
</body>
</html>
